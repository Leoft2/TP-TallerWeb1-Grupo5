...
public class RepositorioUsuarioImpl implements RepositorioUsuario {
    ...
    public Usuario buscarUsuario(String email, String password) {
        ...
        return (Usuario) sessionFactory.getCurrentSession().createCriteria(Usuario.class).add(Restrictions.eq("email", email)).add(Restrictions.eq("password", password)).uniqueResult();
    }
